...
La sortie du programme est : 1

Question 2 :

La sortie du programme est belle et bien 1 et il est plutôt simple de comprendre pourquoi 
si nous observons chaque ligne du main. La première ligne du main nous indique qu’il y a 
la création d’une nouvelle variable « v » qui est un vecteur. Dans ce vecteur, nous avons 
des pointeurs de A. À la deuxième ligne du main nous avons la création d’un objet qui est de type B.
Ensuite, la référence de l’objet b est ajouté au vecteur ce qui fait que le vecteur a une 
taille de 1. Finalement la fonction f() est appelé et la sortie est de 1 parce que la 
classe de base n’est pas polymorphique donc c’est la fonction de la classe A qui est appelé. 
Puisque « v » est de type *A la première méthode appelé est A ::f() et puisqu’elle n’est pas
virtuelle la méthode de la classe B ne sera jamais appelé.

Question 3 :

La première option serait de retirer la virtual devant la fonction de la 
classe B et la seconde façon serait d’enlever la fonction de la classe C.

Question 4 :

Il n’est pas possible d’instancier un objet de type transftert 
parce que cette classe est abstraire donc elle a une méthode virtuelle.
*/
...
int main() {
	...
	*groupe1 += ur4;
	...
	delete ur1; ur1 = nullptr;
	delete ur2; ur2 = nullptr;
	delete ur3; ur3 = nullptr;
	delete ur4; ur4 = nullptr;
	delete up1; up1 = nullptr;
	delete up2; up2 = nullptr;
	delete up3; up3 = nullptr;
	delete up4; up4 = nullptr;
	delete d1; d1 = nullptr;
	delete d2; d2 = nullptr;
	delete uptest; uptest = nullptr;	
	delete d1; d1 = nullptr;
	delete d2; d2 = nullptr;
	delete groupe1; groupe1 = nullptr;
